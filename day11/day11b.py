...
# We can click back to Overview and then in the latest activity area we can click on the build log. Here well be able to see the progress and identify any deployment errors.
